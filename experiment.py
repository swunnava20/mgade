...
def process_sentences(data, model, is_training, learningrate, config, name):
	...
	for sentence_ids_in_batch in batches_of_sentence_ids:
		...
		cost, sentence_scores, token_scores_list, token_probs, token_probs_all_labels, unsup_weights, selective_weights, indicative_weights = model.process_batch(batch, is_training, learningrate)
